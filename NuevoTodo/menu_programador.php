			...
			<article id="content">
				<div class="wrap">
					<section class="cols">
						<div class="box">
							<div>
								<h2 class="letter_spacing"> <span>CONSULTAR DATOS</span></h2>
								<figure><img src="images/page3_img11.jpg" alt="" ></figure>
								<p class="pad_bot1">Consultar datos registrados en la bd.</p>
								<a href="consultasprogramador/consultar.html" class="button1">Ingresar</a>
							</div>
						</div>
					</section>
					<section class="cols pad_left1">
						<div class="box">
							<div>
								<h2> <span>MODIFICAR CUENTAS </span></h2>
								<figure><img src="images/page3_img22.jpg" alt="" ></figure>
								<p class="pad_bot1">Actualizar informacion en la bd.</p>
								<a href="formulariosprogramador/formularios.html" class="button1">Ingresar</a>
							</div>
						</div>
					</section>
					<section class="cols pad_left1">
						<div class="box">
							<div>
								<h2><span>ELIMINAR DATOS</span></h2>
