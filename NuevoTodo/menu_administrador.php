					...
					<section class="cols pad_left1">
						<div class="box">
							<div>
								...
								<a href="modificaradministrador/modificar.html" class="button1">Ingresar</a>
							</div>
						</div>
					</section>
					<section class="cols pad_left1">
						<div class="box">
							<div>
								<h2><span>CONSULTAR DATOS EN LA BD</span></h2>
								<figure><img src="images/page3_img33.jpg" alt="" ></figure>
								<p class="pad_bot1">Consultar informacion en la bd.</p>
