...
// Activar errores
 ...
 $conn=conectarse(); 
		...
		$sql1="Select* from proveedor_insumo where rut_proveedor='$rut'";
...
<script type="text/javascript" src="tablecloth/tablecloth.js"></script>
							...
							echo "</HEAD>";
							echo "<BODY>";
							echo "<h1><u><i> LOS  DATOS DEL PROVEEDOR INSUMO SON:</i></u></h1>";
					...
					else 
					{
							...
							echo "<BODY>";
							echo "<FORM ACTION='pinsumo1.html' METHOD='POST'>";
							echo "<h1><P align='center'>NO HAY DATOS DEL PROVEEDOR INSUMO:</p></h1>";
