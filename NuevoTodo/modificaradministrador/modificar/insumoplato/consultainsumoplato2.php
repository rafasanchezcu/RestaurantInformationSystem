<?PHP
 ...
 $conn=conectarse(); 
	echo $cod_insumo;
		$sql1="Select* from insumo_plato where cod_insumo='".$cod_insumo."'";
				...
				if  ($numrows5!=0) 
					{
							...
							echo "<html>";
							echo "<HEAD>";
							echo "<TITLE> DATOS DEL INSUMO-PLATO </TITLE>";
							?>
...
<script type="text/javascript" src="tablecloth/tablecloth.js"></script>
							...
							echo "</HEAD>";
							echo "<BODY>";
							echo "<h1><u><i> LOS  DATOS DEL INSUMO-PLATO SON:</i></u></h1>";
							...
							echo "</th>";
							echo "<th>";
							echo "CANTIDAD DE INSUMO UTILIZADO";
							echo "</th>";
							...
							if  ($row1 = pg_fetch_array($result1))		
											...
											$insumo=$row1["cod_insumo"];
											$plato=$row1["cod_plato"];
                                            $cantidad=$row1["cant_insumo_utilizado"];
											...
											<td >
											<input  type="text"  name="plato"  disabled="disabled" value=<?PHP echo $plato;?>>
											</td>
											<td >
								...
								echo "</td>";
								echo "</FORM>";	
								echo "<FORM ACTION='insumoplato2.html' METHOD='POST'>";
								echo "<td align='center' >";
