...
<form class="formoid-solid-light-green" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#00aa00;max-width:480px;min-width:150px" method="post"><div class="title"><h2>Insumo</h2></div>
	...
	<div class="element-textarea<?frmd_add_class("textarea")?>"><label class="title"></label><div class="item-cont"><textarea class="medium" name="textarea" cols="20" rows="5" placeholder="Cantidad Del Insumo "></textarea><span class="icon-place"></span></div></div>
